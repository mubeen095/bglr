        ...
        <Container>
          <div class="md:w-2/3 lg:w-1/2">
            ...
            <h2 class="my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
              A technology-first approach to Learnning 
            </h2>
            <p class="text-gray-600 dark:text-gray-300">
            With over 20 courses available upon enrollment, we believe in empowering you to learn what truly matters to you
            Say goodbye to rigid curriculums and hello to the freedom to explore your interests. At Skill Garage, it's all 
            about learning what you want, when you want. Start your journey today and unlock your full potential."
            </p>
          </div>
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Get acess to 20 professional programs,
                    with live and recordes classes 
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Learn form the best in the industary,via our live sessions 
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    Build you own ai powered resume site.
                    45 days of practical placement training.
                  </p>
                </div>
                <a
                  href="#"
            ...
            <div class="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
                ...
                <div class="space-y-2">
                  ...
                  <p class="text-gray-600 dark:text-gray-300">
                    15 mock interviews
                    5 guaranteed placement opportunities
                  </p>
                </div>
                <a
                  href="#"
